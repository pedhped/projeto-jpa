...
public class CriaContaComSaldo {
	...
	public static void main(String args[]) {
		...
		/*Essa linha realiza um update no registro da tabela no banco apesar do registro acabar de ter sido criado, 
		 * pois quando transformamos (em.persist(conta)) a "conta" em manager O JPA automaticamente SETA um "id" pra conta o que possibilita
		 * o UPDATE no registro do banco de dados*/
		...
		/*Esta atualização abaixo não vai surtir efeito no banco de dados, pois após o close() a conta deixa de ser manager*/
